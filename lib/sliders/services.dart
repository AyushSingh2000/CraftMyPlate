...
class _ServicesState extends State<Services> {
  List<CardItemServices> service = [
    CardItemServices(
      platterimg: 'assets/Service/img.png',
      title: 'Signature',
      logo: 'assets/Service/img_3.png',
    ),
    CardItemServices(
      platterimg: 'assets/Service/img_1.png',
      title: 'Value',
      logo: 'assets/Service/img_5.png',
    ),
    CardItemServices(
      platterimg: 'assets/Service/img_2.png',
      title: 'Luxury',
      logo: 'assets/Service/img_7.png',
    ),
  ];
  @override
